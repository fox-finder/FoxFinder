...
import { isDevMode } from '@server/app.environment';
import { PaginateResult, Types } from 'mongoose';
import { Injectable } from '@nestjs/common';
import { InjectModel } from '@server/transforms/model.transform';
import { getGuestbookPageUrl, getArticleUrl } from '@server/transforms/urlmap.transform';
import { parseMarkdownToHtml } from '@server/transforms/markdown.transform';
import { TMongooseModel } from '@server/interfaces/mongoose.interface';
import { ECommentPostType, ECommentState } from '@server/interfaces/state.interface';
import { IpService } from '@server/processors/helper/helper.service.ip';
import { EmailService } from '@server/processors/helper/helper.service.email';
import { AkismetService, EAkismetActionType } from '@server/processors/helper/helper.service.akismet';
import { Option, Blacklist } from '@server/modules/option/option.model';
