...
@observer export class Tooltip extends React.Component<TooltipProps> {
  ...
  @observable private activeContentElementType: ActiveContentTypeValue = null
  @observable private isUpdateElementTypeOntransitionEnd: boolean = false
  @observable private isLastBlurFromContent: boolean = false

  @observable.ref private element: React.RefObject<any> = React.createRef<any>()
